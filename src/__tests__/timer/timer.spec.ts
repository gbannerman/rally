import { convertMillisecondsToTimerValue, convertTimerValueToMilliseconds, getMinutesFromMilliseconds, getSecondsFromMilliseconds, insertSeperator, removeSeperator } from "../../timer/timer";
